...
public class Controller {
    ...
    public ArrayList<XYChart.Series> runPlay(Plays offensePlay, Plays defensePlay, int startLine) {

        play.setPlay(offensePlay, defensePlay, startLine);
        ...
        return play.getSeries(startLine);
    }


    //all below methods are from testing in an early stage
